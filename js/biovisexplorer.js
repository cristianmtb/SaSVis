...
var distanceWeights = {
	...
	changeType: 1.0,
	changeFrequency: 1.0,
	changeAnticipation: 1.0,
	mechanismType: 1.0,
	mechanismAutonomy: 1.0,
	mechanismOrganization: 1.0,
	mechanismScope: 1.0,
	mechanismTime: 1.0,
	mechanismDuration: 1.0,
	mechanismTriggering: 1.0,
	authors: 1.0
};
		...
		for (var j = 0; j <= i; j++) {
			if (i == j)
				row.push({
					...
					changeType: 0,
					changeFrequency: 0,
					changeAnticipation: 0,
					mechanismType: 0,
					mechanismAutonomy: 0,
					mechanismOrganization: 0,
					mechanismScope: 0,
					mechanismTime: 0,
					mechanismDuration: 0,
					mechanismTriggering: 0,
					authors: 0
				});
			else
...
function getSourceDistance(entry1, entry2) {
	...
	dist.goalsMultiplicity = getJaccardDist(
		getFilteredCategories(entry1.categories, "goals-multiplicity"),
		getFilteredCategories(entry2.categories, "goals-multiplicity"));

	// Use the difference in data property categories
	dist.goalsEvolution = getJaccardDist(
		getFilteredCategories(entry1.categories, "goals-evolution"),
		getFilteredCategories(entry2.categories, "goals-evolution"));

	// Use the difference in task categories
	dist.goalsDuration = getJaccardDist(
		getFilteredCategories(entry1.categories, "goals-duration"),
		getFilteredCategories(entry2.categories, "goals-duration"));
	// Use the difference in task categories
	dist.goalsDependency = getJaccardDist(
		getFilteredCategories(entry1.categories, "goals-dependency"),
		getFilteredCategories(entry2.categories, "goals-dependency"));
	dist.changeSource = getJaccardDist(
		getFilteredCategories(entry1.categories, "change-source"),
		getFilteredCategories(entry2.categories, "change-source"));
	// Use the difference in data property categories
	dist.changeType = getJaccardDist(
		getFilteredCategories(entry1.categories, "change-type"),
		getFilteredCategories(entry2.categories, "change-type"));

	// Use the difference in task categories
	dist.changeFrequency = getJaccardDist(
		getFilteredCategories(entry1.categories, "change-frequency"),
		getFilteredCategories(entry2.categories, "change-frequency"));
	// Use the difference in task categories
	dist.changeAnticipation = getJaccardDist(
		getFilteredCategories(entry1.categories, "change-anticipation"),
		getFilteredCategories(entry2.categories, "change-anticipation"));
	dist.mechanismType = getJaccardDist(
		getFilteredCategories(entry1.categories, "mechanism-type"),
		getFilteredCategories(entry2.categories, "mechanism-type"));

	// Use the difference in data property categories
	dist.mechanismAutonomy = getJaccardDist(
		getFilteredCategories(entry1.categories, "mechanism-autonomy"),
		getFilteredCategories(entry2.categories, "mechanism-autonomy"));

	// Use the difference in task categories
	dist.mechanismOrganization = getJaccardDist(
		getFilteredCategories(entry1.categories, "mechanism-organization"),
		getFilteredCategories(entry2.categories, "mechanism-organization"));
	// Use the difference in task categories
	dist.mechanismScope = getJaccardDist(
		getFilteredCategories(entry1.categories, "mechanism-scope"),
		getFilteredCategories(entry2.categories, "mechanism-scope"));
	dist.mechanismTime = getJaccardDist(
		getFilteredCategories(entry1.categories, "mechanism-time"),
		getFilteredCategories(entry2.categories, "mechanism-time"));
	// Use the difference in data property categories
	dist.mechanismDuration = getJaccardDist(
		getFilteredCategories(entry1.categories, "mechanism-duration"),
		getFilteredCategories(entry2.categories, "mechanism-duration"));

	// Use the difference in task categories
	dist.mechanismTriggering = getJaccardDist(
		getFilteredCategories(entry1.categories, "mechanism-triggering"),
		getFilteredCategories(entry2.categories, "mechanism-triggering"));
